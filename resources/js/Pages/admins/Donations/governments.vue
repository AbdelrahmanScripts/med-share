        ...
        <div class="container mt-20">
           <div class="grid grid-cols-4">
             <div class="flex justify-center">
                 <div
                     class="block max-w-[18rem] rounded-lg border border-blue-500 bg-white shadow-secondary-1 dark:bg-surface-dark">
                     <div
                         class="border-b-2 border-neutral-100 px-6 py-3 text-surface dark:border-white/10 dark:text-white">
                         Header
                     </div>
                     <div class="p-6">
                         <h5 class="mb-2 text-xl font-medium leading-tight text-blue-800">
                             Primary card title
                         </h5>
